...
node {
  ...
  stage ('Build') {
    docker.image('jekyll/builder:3.6.2').inside('-e DEBUG=true -e https_proxy=$HTTPS_PROXY -e HTTPS_PROXY -e http_proxy=$HTTP_PROXY -e HTTP_PROXY  -v $WORKSPACE:/srv/jekyll -u 0:0') {
