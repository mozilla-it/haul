...
node {
  ...
  stage ('Build') {
    docker.image('dhartnell/mozilla-planet-builder:4.4').inside("-u 0:0 -e https_proxy=$HTTPS_PROXY -e HTTPS_PROXY -e http_proxy=$HTTP_PROXY -e HTTP_PROXY -v /data/haul/.planet-cache/${env.JOB_NAME}:/data/efs/") {
